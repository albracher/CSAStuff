...
public class College extends High {
    ...
    public College(int sAge, String nName, char sGender, boolean isReader, boolean isWriter, String sMathLevel, boolean sScience, boolean sIntMath, boolean sHistory,
                   String sMathLvl, String sEngLevel, String sSport, boolean sBibleTeaching, boolean sParty, boolean sProcrastinate, boolean sCheat) {
        super(sAge, nName, sGender, isReader, isWriter, sMathLevel, sScience, sIntMath, sHistory, sMathLvl, sEngLevel, sSport, sBibleTeaching);
        canParty = sParty;
